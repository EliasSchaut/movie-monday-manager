...
export class UserController {
  ...
  @UseGuards(JwtAuthGuard)
  @Post()
  async update_profile(@User() user: JwtUser, @Body() body: ProfileDto, @I18n() i18n: I18nContext): Promise<ResDto> {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('email_opt_in')
  async email_opt_in(@User() user: JwtUser, @Body() body: EmailOptInDto, @I18n() i18n: I18nContext): Promise<ResDto> {
  ...
  @UseGuards(JwtAuthGuard)
  @Delete()
  async delete(@User() user: JwtUser, @Body() body: PasswordDto, @I18n() i18n: I18nContext): Promise<ResDto> {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('username')
  async change_username(@User() user: JwtUser, @Body() body: LoginDto, @I18n() i18n: I18nContext): Promise<ResDto> {
  ...
  @UseGuards(JwtAuthGuard)
  @Post('password')
  async change_password(@User() user: JwtUser, @Body() body: PasswordNewDto, @I18n() i18n: I18nContext): Promise<ResDto> {
